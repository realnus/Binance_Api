...
#NusLib Import
import sys
sys.path.insert(1, 'C:\\MyProjects2\\CC\\Binance_Api\\WebSocketInstantDownload\\Ftx')       
...
class FtxWebsocketClient(WebsocketManager):
    ...
    def __init__(self) -> None:
        ...
        self._api_key = 'oqo-sqbV7D23LcnjBnpknwe7FUcL2j60jYiHpNIB'  # TODO: Place your API key here
        self._api_secret = '0q3WJ3-QWlqdedUALiwFGM5xJC3oB_s_qDsKFjVD'  # TODO: Place your API secret here
